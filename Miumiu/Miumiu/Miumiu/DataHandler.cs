...
class DataHandlerMSSQL : DataHandler
{
        ...
        if (secondinterval > 0)
        {
            ...
            foreach (KeyValuePair<DateTime, List<DataRow>> kvp in tradetimeDict)
            {
                ...
                if (kvp.Value.Count > 0)
                {
                    ...
                    intraDict[kvp.Key]["SD"] = Math.Round(Tools.StandardDeviation(tradeClose.ToArray(), false), 3);
                ...
                for (int j = 0; j < indicName.Length; j++)
                {
                    ...
                    {//Add Column
                        ...
                        if (!dt.Columns.Contains(colname))//Check existing column
                            dt.Columns.Add(colname, System.Type.GetType("System.Double"));
                    }
                    ...
                    if (indicName[j] == "Volatility")
                    {
                        ...
                        if (i >= period)
                        {
                            ...
                            for (int k = 1; k < period; k++)
                            {
                                ...
                                val.Add(pchange);
                                double volat = Math.Sqrt(period) * Tools.StandardDeviation(val.ToArray(), false);
                                string colname = indicName[j];
    ...
    private DataTable OrderTable()
    {
        ...
        col[1] = new DataColumn("OpenPosition", Type.GetType("System.String"));
        col[2] = new DataColumn("OpenTime", Type.GetType("System.TimeSpan"));
        col[3] = new DataColumn("OpenPrice", Type.GetType("System.Double"));
        col[4] = new DataColumn("ClosePosition", Type.GetType("System.String"));
        col[5] = new DataColumn("CloseTime", Type.GetType("System.TimeSpan"));
        col[6] = new DataColumn("ClosePrice", Type.GetType("System.Double"));
        col[7] = new DataColumn("Interval", Type.GetType("System.Double"));
    ...
    private Dictionary<DateTime, DataRow> IntradayTimeTradeDict(DataTable dateListTable,int secondinterval)
    {
        ...
        if (secondinterval > 0)
        {
            ...
            col[20] = new DataColumn("SD", Type.GetType("System.Double"));
            col[21] = new DataColumn("VF", Type.GetType("System.Double"));
            col[22] = new DataColumn("Long TPS", Type.GetType("System.Double"));
            col[23] = new DataColumn("Short TPS", Type.GetType("System.Double"));
            col[24] = new DataColumn("SumShortVol Biglots", Type.GetType("System.Double"));
            col[25] = new DataColumn("SumLongVol Biglots", Type.GetType("System.Double"));
            col[26] = new DataColumn("SumShortTrans Biglots", Type.GetType("System.Double"));
            col[27] = new DataColumn("SumLongTrans Biglots", Type.GetType("System.Double"));
            col[28] = new DataColumn("AvgShortCost Biglots", Type.GetType("System.Double"));
            col[29] = new DataColumn("AvgLongCost Biglots", Type.GetType("System.Double"));
    ...
    {
        bar.Columns.Add("Hash1", Type.GetType("System.String"));
        bar.Columns.Add("Hash2", Type.GetType("System.String"));
